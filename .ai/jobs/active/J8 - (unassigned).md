...
- Archive:
  - Move this log to `.ai/jobs/done/YYYY-MM-DD_HHMMUTC_J8 - <title>.md`
  ...
  - Reset slot J8 in `.ai/BLACKBOARD.md` to `(unassigned)` and `Lock: 🔓`
  - Ensure placeholder exists: `.ai/jobs/active/J8 - (unassigned).md`
